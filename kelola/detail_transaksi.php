...
<body>
                            ...
                            <div class="col-8">
                                <h6>:
                                    ...
                                    <button type="button" style="border: none; background: none;" data-bs-toggle="modal"
                                        data-bs-target="#statusModal"><i class="bi bi-pencil-fill"></i></button>
                                </h6>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Modal Status -->
    <div class="modal fade modal-dialog-scrollable" id="statusModal" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <!-- Modal Bayar -->
    <div class="modal fade modal-dialog-scrollable" id="bayar" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="" method="post">
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control" id="jumlah2" name="jumlah2" readonly placeholder=""
